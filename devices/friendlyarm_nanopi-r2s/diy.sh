...
sed -i "s/CONFIG_PACKAGE_kmod-shortcut-fe-cm=y/# CONFIG_PACKAGE_kmod-shortcut-fe-cm is not set/" .config
sed -i "s/CONFIG_PACKAGE_kmod-shortcut-fe-dns=y/# CONFIG_PACKAGE_kmod-shortcut-fe-dns is not set/" .config
